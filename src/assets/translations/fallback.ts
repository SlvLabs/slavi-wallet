const translations = {
  ...
  Fast: 'Fast',
  Advanced: 'Advanced',
  'Are you sure you want to send funds to the following addresses?':
    'Are you sure you want to send funds to the following addresses?',
  ...
  'We offer you a convenient system that will help solve all your problems with cryptocurrency':
    'We offer you a convenient system that’ll help solve all your problems with cryptocurrency',
  Language: 'Language',
  Currency: 'Currency',
  'Attention!': 'Attention!',
  Back: 'Back',
  ...
  'Can not create transaction. Try latter or contact support.':
    'Can not create transaction. Try latter or contact support.',
  'Error of transaction creating': 'Error of transaction creating',
  'Error of broadcast tx. Try again latter or contact support':
    'Error of broadcast tx. Try again latter or contact support',
  ...
  'Your version of the app is out of date. You need to install a more recent.':
    'Your version of the app is out of date. You need to install a more recent.',
  'Get it': 'Upload here',
  ...
  'Are you sure you want to delete your translations cache data?':
    'Are you sure you want to delete your translations cache data?',
  ...
  walletConnectDescription:
    'Sign transactions, execute any smart contracts, invest into defi through our app using the wallet-connect protocol',
  ...
  restoreDescription:
    'To recover your pin code, you need to completely reset your app data, including your passphrase and all private address keys.',
  restoreAccept: 'Accept',
  restoreDecline: 'Back',
  pinCode: 'Pin code',
  disablePinConf: 'Disable pin code',
  initPinDescription:
    'Set up a secure and convenient method of accessing the application. Use a PIN code and biometric authentication. These measures protect your wallet from unauthorized access in the event you lose your device.',
  ...
  'Sorry, our service is not available in the location you are in':
    'Sorry, our service is not available in the location you are in',
  ...
  logoutDescription:
    'Logging out can result in the loss of access to your funds inside this wallet. Please save your private keys',
  ...
  stakingTermOfUseLink: 'https://slavi.io/',
  '3_MONTH': '3 Months',
  '6_MONTH': '6 Months',
  '12_MONTH': '12 Months',
  ...
  stakingStatus_init: 'Confirmation awaiting',
  stakingStatus_working: 'In work',
  stakingStatus_waitingWithdraw: 'Waiting withdraw',
  stakingStatus_done: 'Done',
  stakingStatus_rejected: 'Rejected',
  stakingDescription:
  ...
  stakingLessThenMinStake: 'Can not stake less then {{amount}} {{ticker}}',
  stakingRewardsNotFound: 'You dont have payments yet',
  operationEarnDeposit: 'Earning deposit',
  operationEarnWithdraw: 'Earning withdraw',
  operationEarnPayment: 'Earning Payment',
  stakingWalletDeposit: 'Earning deposit',
  stakingWalletWithdraw: 'Earning withdraw',
  stakingWalletReward: 'Earning reward',
  ...
  referralInitDescription1: 'Join our brand new event  and earn Teddies.',
  referralInitDescription2: 'Be the one who share',
  ...
  referralWrong: 'Wrong',
  captcha: 'Captcha',
  referralTitle: 'Reward campaign',
  referralPoints: 'Your points',
  referralPts: 'pts',
  referralInvited: 'You have invited',
  referralFriends: '{{count}} friends',
  referralShare: 'Share your referral code',
  referralDescription: 'You will get {{percent}}% from each completed task by your referral',
  referralInviting: 'Code of friend that invited you',
  referralInvites: 'Invite a friend',
  referralDeposit: 'Deposit and Hold',
  referralSwap: 'Swap',
  referralStake: 'Stake',
  referralBuyCrypto: 'Buy Crypto',
  referralHoldNft: 'Hold NFT',
  referralRules: 'Rules',
  referralRulesText:
    'At the end of the campaign, all points will be converted into SLV tokens, depending on the number of participants. The total pool is $500,000 and will be distributed based on the number of points earned and the total number of participants. You can see more detailed information on accruing points by clicking on the icon in the upper right corner.',
  copied: 'Copied',
  referralRuleUpToAmount: '+ up to {{amount}}',
  referralRuleAmount: '+ {{amount}}',
  referralRuleUpToPercent: '+ up to {{percent}}%',
  referralRulePercent: '+{{percent}}%',
  referralRulePositionPoints: '+{{points}} pts',
  referralRulePositionPercent: '+{{percent}}%',
  referralCommonRules:
    'At the end of the campaign, all points will be converted into SLV tokens, depending on the number of participants. The total pool is $500,000 and will be distributed based on the number of points earned and the total number of participants. You can see more detailed information on accruing points by clicking on the icon in the upper right corner.',
  referralHelpPageUrl: 'https://medium.com/',
  referralCongratulations: 'Congratulations',
  referralEarned: 'You have earned',
  referralResultPoints: 'points',
  referralStayInTouch: 'Please stay in touch in our Telegram and Discord chat.',
  referralFutureSteps: 'After calculation we will announce further steps.',
  referralTelegram: 'Telegram',
  referralDiscord: 'Discord',
  referralConvertedSlv: 'Converted into',
  referralTokens: 'tokens',
  referralCodeDescription1: 'Please register on ',
  referralExchange: 'Slavi.io,',
  referralExchangeLink: 'https://slavi.io/',
