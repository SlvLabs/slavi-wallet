...
const OperationElementPolkadotInvestToLock = (props: OperationProps) => {
  ...
  return (
    <AbstractOperationMovement
      ...
      title={t('operationPolkadotInvestToLock')}
      logo={getImageSource(coinData?.logo)}
    />
  );
};

export default OperationElementPolkadotInvestToLock;
