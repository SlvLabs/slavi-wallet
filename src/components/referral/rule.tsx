...
export function Rule({header, maxAmount, amount, percent, maxPercent, description, positions, children}: RuleProps) {
  ...
  return (
    <TouchableOpacity style={styles.container} onPress={onPress}>
      <View style={styles.headerRow}>
        <Text style={styles.title}>{t(header as TranslationsKey)}</Text>
      ...
      {opened && (
        <View style={styles.body}>
          <Text style={styles.description}>{t(description as TranslationsKey)}</Text>
